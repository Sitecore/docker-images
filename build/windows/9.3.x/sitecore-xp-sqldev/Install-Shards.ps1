...
& $shardToolExe /operation create /connectionstring "Server=.;Trusted_Connection=True;" /shardMapManagerDatabaseName $dbShardMapManager /dbedition Basic /shardnumber 2 /shardnameprefix $dbShardNamePrefix /shardnamesuffix '""' /dacpac $dacPacPath
