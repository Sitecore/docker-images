...
Expand-Archive -Path (Join-Path $InstallPath "\\*(OnPrem)*xconnect*.zip") -DestinationPath $shardToolPath

$dbShardMapManager = "{0}_Xdb.Collection.ShardMapManager" -f $DatabasePrefix;
$dbShardNamePrefix = "{0}_Xdb.Collection.Shard" -f $DatabasePrefix;
