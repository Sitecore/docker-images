...
Param (
    ...
    [Parameter(HelpMessage = "Includes Horizon authoring host in initialization process")]
    [switch]$IncludeHorizon,
...
Add-HostsEntry "cm.sc.localhost"
Add-HostsEntry "cd.sc.localhost"
Add-HostsEntry "id.sc.localhost"
Add-HostsEntry "www.sc.localhost"

if ($IncludeHorizon)
{
    Add-HostsEntry "sh.sc.localhost"
}
...
if ($InitEnv)
{
    ...
    # CM_HOST
    Set-DockerComposeEnvFileVariable "CM_HOST" -Value "cm.sc.localhost"

    # ID_HOST
    Set-DockerComposeEnvFileVariable "ID_HOST" -Value "id.sc.localhost"

    if ($IncludeHorizon)
    {
        # SH_HOST
        Set-DockerComposeEnvFileVariable "SH_HOST" -Value "sh.sc.localhost"
    }

    # RENDERING_HOST
    Set-DockerComposeEnvFileVariable "RENDERING_HOST" -Value "www.sc.localhost"
    ...
    # TODO: does this need to be updated to be *.sc.localhost ??
