...
if ($useWatchDirectory)
{
    ...
    {
        $WatchDirectoryParameters = @{ Path = "C:\src"; Destination = "C:\AutomationEngine"; }
    }
...
$LicenseFileTargetPath = "C:\AutomationEngine\App_Data\license.xml"

Copy-Item $licenseFilePath -Destination $LicenseFileTargetPath -Force

# print ready message
Write-Host ("$(Get-Date -Format $timeFormat): Automationengine ready!")
